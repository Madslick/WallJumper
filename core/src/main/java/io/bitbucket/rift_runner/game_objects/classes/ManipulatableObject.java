...
import io.bitbucket.rift_runner.game_objects.LandDust;
import io.bitbucket.rift_runner.game_objects.particles.WallJumpParticle;
...
public class ManipulatableObject extends AbstractGameObject {
	...
	protected Animation<TextureRegion> zAttack;
	protected Animation<TextureRegion> aniLanding;

	public Animation<TextureRegion> aniJumping, aniWalling;
