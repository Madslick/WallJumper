...
public class SceneAssets implements Disposable, AssetErrorListener {
	...
	public class UI {
		...
		public final Animation<TextureRegion>buttonAnimation;

		public final Array<AtlasRegion> riftFragFiles;
		public final Animation<TextureRegion>riftFragment;
		...
		public UI(TextureAtlas atlas){
			...
			buttonAnimation = new Animation<>(1 / 10f, animationPngs, Animation.PlayMode.NORMAL);
			riftFragFiles = atlas.findRegions("riftFrag");
			riftFragment = new Animation<>(1 / 10f, riftFragFiles, Animation.PlayMode.LOOP);
